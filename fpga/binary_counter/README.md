# test_proj - ECP5-5G Versa Development Kit
...
├── src/
│   └── test_proj.vhdl # RTL source code
├── sim/
│   └── test.vhdl         # Testbench
...
Edit the RTL source file [src/test_proj.vhdl](src/test_proj.vhdl) to implement your design.
