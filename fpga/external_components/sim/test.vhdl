...
entity external_components_tb is
end external_components_tb;

-- Architecture for the testbench - describes the test setup
architecture sim of external_components_tb is

    -- Component declaration: describes the interface of the module we're testing
    component external_components is
        generic (
        ...
        port (
            ...
            test_pin7 : out std_logic                 -- Test output on X3 pin 7
        );
    end component;
    ...
    signal btn : std_logic := '1';                   -- Button signal, starts at '1' (not pressed)
    signal led : std_logic_vector(7 downto 0);       -- 8-bit LED output
    signal test_pin7 : std_logic;                    -- Test pin 7 output
